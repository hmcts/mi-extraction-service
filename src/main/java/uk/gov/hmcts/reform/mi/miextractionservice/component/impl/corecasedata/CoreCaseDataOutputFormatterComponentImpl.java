    ...
    public OutputCoreCaseData formatData(CoreCaseData coreCaseData) {
        try {
            return OutputCoreCaseData
                ...
                .cd_created_date(getStringFromDate(coreCaseData.getCdCreatedDate()))
                .cd_last_modified(getStringFromDate(coreCaseData.getCdLastModified()))
                ...
                .cd_last_state_modified_date(getStringFromDate(coreCaseData.getCdLastModified()))
